...
- The size of a swap area should not be less than the amount of physical memory; however, 
...
- or set it up for automatic activation by placing an entry in the fstab file. 
- The fstab file accepts the swap area's device file, UUID, or label.
### Exercise 14-5: Create and Activate Swap in Partition and Logical Volume (server 2)
