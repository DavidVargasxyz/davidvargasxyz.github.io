Right now, i read all of my books using the Bookfusion app. When you export the highlights, it comes with a lot of metadata such as highlight color, time/date, etc. I don’t need all of that so here is how I get rid of it.

My highlights pulled up in the Vim editor:
